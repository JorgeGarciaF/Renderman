...
int main(int argc, char *argv[])
{
    ...
    static RtFloat Ka = 1.0, Kd = 1.0, Ks = .5, roughness = 0.25, outlinethickness = 1.0;
    static RtPoint from = {0,0,1}, to = {0,10,0};
    static RtColor orange = { .9, .3, .0};
    RiBegin(RI_NULL);
    ...
    RiSurface ((RtToken)"cel", "Ka", &Ka, "Kd", &Kd, "Ks", &Ks, "roughness", &roughness, "outlinethickness", &outlinethickness, RI_NULL);
    RiColor(orange);
    RiTranslate(0,0,2);
